...
export default {
  ...
  data() {
    return {
      ...
      recommendData: [],
      carousel_top: [
        require('@/assets/imgs/c1.jpg'),
        require('@/assets/imgs/c2.jpg'),
        require('@/assets/imgs/c9.jpg'),
      ],
      carousel_left: [
        require('@/assets/imgs/c3.jpg'),
        require('@/assets/imgs/c4.jpg'),
        require('@/assets/imgs/c5.jpg'),
      ],
      carousel_right: [
        require('@/assets/imgs/c6.jpg'),
        require('@/assets/imgs/c7.jpg'),
        require('@/assets/imgs/c8.jpg'),
      ],
    }
  },
  mounted() {
