<template>
  <div class="main-content">
    <div style="width: 70%; background-color: white; margin:30px auto; border-radius: 20px">
      <div style="padding: 5px 20px">
        <div style="display: flex; font-size: 18px; color: #000000FF; line-height: 80px; border-bottom: #cccccc 1px solid">
          <div style="flex: 6 ; margin-left: 20px">我的地址</div>
          <div style="flex: 1">
            <el-button type="primary" round @click="addaddress">添加收货地址</el-button>
          </div>
        </div>
    ...
    <el-dialog name="地址信息" :visible.sync="formVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
