      ...
      <div style="width: 250px; padding: 0 20px; border-left: #cccccc 1px solid">
        ...
        <div style="margin: 20px 0; padding: 0 10px">
          <div style="margin-bottom: 20px">
            ...
            <div style="margin-top: 10px; font-weight: 500; font-size: 16px; width: 170px; color: #000000FF; text-overflow: ellipsis; overflow: hidden; white-space: nowrap">图片名字</div>
